...
import logoMini from '@/public/assets/images/logo.png'
import Link from 'next/link';
import MainMenu from './MainMenu';
import AdminMenu from './AdminMenu';

const AdminMobileMenu = ({ toggleSubMenu, isMobileSidebarOpen, openMobileSidebar, closeMobileSidebar, isMenuSticky }) => {
    return (
        <>
            <div className={`mobile-menu-area d-block d-lg-none ${isMenuSticky ? "sticky-nav" : ""}`}>
                ...
                <div className={`mobile-sidebar-wrap ${isMobileSidebarOpen ? "show" : ""}`}>
                    ...
                    <div className="sidebar-body">
                        <AdminMenu toggleSubMenu={toggleSubMenu} />
                    </div>
                </div>
            </div>
        </>
