                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-2">
                            <div className="header-logo">
                                <Link href="/"><Image src={logo2} alt="logo" width={60} height={60} /></Link>
                            </div>
                        </div>
                        <div className="col-lg-10">
                            <div className="header-munu style-two">
                                ...
                                <div className="header-social style-two">
                                    <ul>
                                        <li className="upper">
                                            <Link href="#" className="search-box-btn search-box-outer"  onClick={handleSearchOpen}><i className="bi bi-search"></i></Link>
                                        </li>
                                    </ul>
                                </div>
